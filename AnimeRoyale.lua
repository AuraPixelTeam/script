...
local RenUi = library:CreateWindow("JG X ",Color3.fromRGB(0,255,255),"Anime Royale")
-------------------------------------------------------------------
local Main = RenUi:AddTab("Main")
local Macro = RenUi:AddTab("Macro")
local Webhook = RenUi:AddTab("Webhook")
local Autoplay = RenUi:AddTab("Auto Play")
